...
android {
    ...
    namespace = "app.svitok.vault"
    defaultConfig {
        manifestPlaceholders["usesCleartextTraffic"] = "false"
        applicationId = "app.svitok.vault"
        minSdk = 24
        targetSdk = 36
...
dependencies {
    ...
    // свой сканер QR: CameraX даёт кадры, ZXing-core (чистая Java, Apache-2.0)
    // декодирует. Никакого ML Kit / GMS / телеметрии.
